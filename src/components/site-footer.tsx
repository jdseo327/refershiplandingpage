...
export function SiteFooter() {
  return (
    <footer className="bg-zinc-100 dark:bg-zinc-900 py-8 sm:py-12">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center mb-3 sm:mb-4">
              <LogoIcon className="h-6 w-6 sm:h-8 sm:w-8 mr-2" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8">
            <div>
              <h4 className="text-xs sm:text-sm font-semibold text-zinc-900 dark:text-white mb-3 sm:mb-4 uppercase">
                Product
              </h4>
        ...
        <div className="border-t border-zinc-200 dark:border-zinc-800 mt-8 sm:mt-12 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center">
