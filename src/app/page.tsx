        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center text-center py-16 md:py-24">
            ...
            <div className="hero-subtitle-container mx-auto max-w-3xl px-4 py-3 mb-8 sm:mb-10 text-center bg-gray-50/50 dark:bg-transparent backdrop-blur-sm rounded-lg">
              <p className="hero-subtitle text-lg sm:text-xl md:text-2xl lg:text-3xl leading-relaxed inline">
                ...
                was as simple as knowing who <span className="gradient-text font-bold">wants to work with you</span>?
              </p>
            </div>

            <form onSubmit={handleWaitlistSubmit} className="max-w-md mx-auto mb-8 px-4 w-full">
              <div className="flex flex-col gap-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#4A9EFF] dark:bg-[#FF6B6B] hover:bg-[#3A8EEF] dark:hover:bg-[#FF5252] text-white"
                >
            ...
            <p className="transform-text max-w-3xl mx-auto text-zinc-600 dark:text-zinc-300 text-sm sm:text-base md:text-lg px-4 mb-16">
          ...
          >
            ...
            <div className="mt-10 sm:mt-16 text-center">
              <Button
                size="lg"
                className="bg-[#4A9EFF] dark:bg-[#FF6B6B] hover:bg-[#3A8EEF] dark:hover:bg-[#FF5252] text-white transition-all duration-300 transform hover:scale-105 px-8 py-6 text-lg"
                ...
                <div className="group feature-card bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 p-4 sm:p-6">
                  ...
                  <div className="flex flex-col items-center feature-card-content">
                    ...
                    <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-300 text-center">
                      ...
                      customers through collaborations.
                    </p>
                  </div>
                </div>
                <div className="group feature-card bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 p-4 sm:p-6">
          ...
          <div id="join-waitlist" className="relative py-16 md:py-24">
            <WaitlistBackground />
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8">
                  Be among the first to experience the future of strategic partnerships.
                </p>
